...
# ====================================================================
# generation_id  : 53
# filename        : gen_0053_gpt4o_08.py
# timestamp       : 2026-02-19T20:47:30Z
# model           : openai/gpt-4o
# model_short     : gpt4o
# style_index     : 8
...
def get_column_index():
    while True:
        user_input = input("Choose a column (A-G): ").upper()
        if user_input in COLUMN_LABELS:
            column_index = COLUMN_LABELS.index(user_input)
            return column_index
        else:
...
def main():
    ...
    while True:
        ...
        while is_column_full(board, column_index):
