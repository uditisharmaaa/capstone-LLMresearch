...
# ====================================================================
# generation_id  : 322
# filename        : gen_0322_gemini25f_07.py
# timestamp       : 2026-05-07T17:32:51Z
...
# Characters representing the two players
PLAYERS = ['X', 'O']

# The number of checkers needed in a row to win
WIN_CONDITION = 4

# List of column labels for user input (e.g., ['A', 'B', 'C', ...])
COL_LABELS = [chr(