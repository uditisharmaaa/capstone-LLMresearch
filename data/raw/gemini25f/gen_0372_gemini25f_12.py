...
# ====================================================================
# generation_id  : 372
# filename        : gen_0372_gemini25f_12.py
# timestamp       : 2026-05-07T17:52:16Z
...
EMPTY_SLOT = ' '
PLAYERS = ['X', 'O']
WIN_CONDITION = 4 # Number of consecutive checkers for a win

# --- Board Functions ---

def create_board():
    """Initializes a 2D board with empty slots."""
