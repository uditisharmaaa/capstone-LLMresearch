...
# ====================================================================
# generation_id  : 352
# filename        : gen_0352_gemini25f_07.py
# timestamp       : 2026-05-07T17:46:36Z
...
COLUMN_LABELS = 'ABCDEFG' # For user input and display

# --- Function to create an empty Connect 4 board ---
def create_board():
    # A board is a list of lists, where each inner list represents a