...
# ====================================================================
# generation_id  : 417
# filename        : gen_0417_gemini25f_12.py
# timestamp       : 2026-05-07T19:16:25Z
...
def initialize_board():
    """
    Creates a 2D board initialized with empty spaces.
    """
    return [[EMPTY_SPACE for _ in range(NUM_COLS)] for _ in range(NUM_ROWS)]
