...
# ====================================================================
# generation_id  : 259
# filename        : gen_0259_llama_09.py
# timestamp       : 2026-04-06T09:44:47Z
...
while True:
    print_board()
    print("Player", "X" if current_player == 0 else "O", "turn")
    ...
    for row in range(BOARD_ROWS-1, -1, -1):
        if board[row][ord(move) - ord('A')] == ' ':
            board[row][ord(move) - ord('A')] = 'X' if current_player == 0 else 'O'
            break

    # Check for a win
    if check_win('X' if current_player == 0 else 'O'):
        print_board()
        print("Player", "X" if current_player == 0 else "O", "won!")
        break
