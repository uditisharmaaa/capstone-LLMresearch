...
# ====================================================================
# generation_id  : 388
# filename        : gen_0388_gemini25p_13.py
# timestamp       : 2026-05-07T17:57:19Z
...
def create_board():
    """Creates and returns an empty 2D list for the game board."""
    return [[' ' for _ in range(COLS)] for _ in range(ROWS)]

def print_board(board):
    """Prints the game board in the required format."""
