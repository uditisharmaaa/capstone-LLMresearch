...
# ====================================================================
# generation_id  : 389
# filename        : gen_0389_sonnet46_14.py
# timestamp       : 2026-05-07T17:57:30Z
...
def get_move(b,p):
    while True:
        s=input(f'Player {p} ({CHECKERS[p-1]}), choose column (A-G): ')
        if len(s)!=1 or not s.isalpha() or s.upper() not in COLS_LABELS:
            print('Invalid input. Enter a letter A-G.')
            continue
        c=COLS_LABELS.index(s.upper())
        if b[0][c]!=' ':
