...
# ====================================================================
# generation_id  : 461
# filename        : gen_0461_sonnet46_04.py
# timestamp       : 2026-05-07T22:43:06Z
...
def play_game():
    ...
    while True:
        ...
        col_index = get_player_input(board, checker)
        row = drop_checker(board, col_index, checker)
        print_board(board)

        if check_win(board, row, col_index, checker):
