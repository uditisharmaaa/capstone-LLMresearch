...
# ====================================================================
# generation_id  : 171
# filename        : gen_0171_gpt4mini_11.py
# timestamp       : 2026-04-06T09:15:49Z
...
# Constants for the board dimensions and player count
ROWS = 6
COLUMNS = 7
PLAYERS = 2
...
def check_win(board, checker):
    """Checks for a win condition for the given checker."""
    # Check horizontal
    for row in board:
...
def main():
    ...
    while True:
        ...
        while not is_valid_input(column, board):
            print("Invalid input. Please choose a column from A to G that is not full.")
            column = input(f"Player {current_player}, choose a column (A-G): ").upper()
